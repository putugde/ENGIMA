...
function create_sample_table(parentNode, body, data, url)
{
    ...
    temp.forEach(function (item, ignore) {
        var src = item.poster_path;
        var img = document.createElement("img");
        img.setAttribute("src", "http://image.tmdb.org/t/p/w185" + src);
        ...
        link.setAttribute("href", url + "/film/index/" + item.id);
        ...
        th2.innerHTML = item.vote_average;
